  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 fade-in">
      <div className="bg-white/95 backdrop-filter backdrop-blur-xl rounded-2xl shadow-2xl max-w-2xl w-full mx-auto max-h-[90vh] overflow-y-auto border border-slate-200">
        {/* Header */}
        <div className="sticky top-0 bg-gradient-to-r from-emerald-50 to-teal-50 border-b border-slate-200 px-4 sm:px-6 md:px-8 py-4 sm:py-6 flex justify-between items-start sm:items-center gap-4">
          <div className="flex-1 min-w-0">
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 break-words">Create New Course</h2>
            <p className="text-slate-600 text-xs sm:text-sm mt-1 hidden sm:block">Fill in the details to create your new course</p>
          </div>
          <button
            onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="form-input resize-none"
                placeholder="List learning outcomes, one per line or separated by commas..."
                rows="4"
              />
              <p className="text-xs text-slate-500 mt-2 flex items-center gap-1">
                <span>💡</span> Enter each learning outcome on a new line for better formatting
              </p>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="form-input resize-none"
                placeholder="List course prerequisites and requirements, one per line..."
                rows="4"
              />
              <p className="text-xs text-slate-500 mt-2 flex items-center gap-1">
                <span>💡</span> Enter each requirement on a new line for better formatting
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-2 flex items-center gap-1">
                <span>ℹ️</span> Save as Draft to work on it later, or Publish to make it available to students
              </p>
            </div>
